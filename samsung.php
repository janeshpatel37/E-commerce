...
<nav class="nav">
    ...
    $q = "SELECT * FROM products WHERE category='samsung';";
...
while($res = mysqli_fetch_array($r))
{
    ...
    echo "<h4>$pName</h4>";
    echo "<br>";
    echo '<div> <img height=400px width=200px src="data:images/jpeg;base64,'.base64_encode( ($image) ).'"/>';                      
    echo "<br>";
    echo "</div>";
    echo "<div><strong>Description: </strong>$description";
    echo "</div>";
    echo "<br>";
